 ...
 * -----------------------------------------------------
 * Dynamic widget visibility only.  Backend slot_count remains authoritative.
 */
...
const NODE_NAMES = new Set([
    "JLC_ControlNetComposition",
    "JLC_DynamicControlNetComposition",
]);

const JLC_PRIMARY_BUTTON_BLUE = "#0B8CE9";
const JLC_PRIMARY_BUTTON_TEXT = "#FFFFFF";
const LAYOUT_KEY = "__jlc_dynamic_controlnet_composition_layout";
const INSTALL_FLAG = "__jlc_dynamic_controlnet_composition_installed";
...
function slotWidgetNames(index) {
    return [`weight_${slotSuffix(index)}`];
}
